package com.minhld.copynsee.components;
...
public class CircularProgressBar extends ProgressBar{
	...
	public void init(AttributeSet attrs, int style){
		...
		String t = a.getString(R.styleable.CircularProgressBar_titleEx);
		if(t!=null)
			mTitle = t;

		t = a.getString(R.styleable.CircularProgressBar_subtitleEx);
		if(t!=null)
			mSubTitle = t;
